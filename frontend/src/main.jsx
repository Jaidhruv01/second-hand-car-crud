...
function App(){
  ...
  return <div>
    ...
    <section className="hero"><div><p className="eyebrow"> VERIFIED. SIMPLE.</p><h1>Find <br/><span>perfect drive.</span></h1><p>Browse quality second-hand cars or list yours in minutes.</p></div></section>
    <main>
